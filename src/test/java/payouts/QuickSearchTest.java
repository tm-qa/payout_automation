...
public class QuickSearchTest extends TestBase {
    ...
    public void verifyValid_QuickSearchSection() throws InterruptedException {
        ...
        quickSearchPage.searchByValid_From_To_Cycles_But_DataNotPresent("63b54bb9ee10470001250bb6","MIS_AHSBF7UN56P","Dec 2025 C1","Dec 2025 C2");
    }

    @Test(priority = 1, enabled = true, retryAnalyzer = RetryAnalyser.class)
    public void verifyInvalid_QuickSearchSection() throws InterruptedException {
        ...
        quickSearchPage.searchByValid_From_To_InvalidCycleRange("63b54bb9ee10470001250bb6","MIS_AHSBF7UN56P","Nov 2025 C2","Nov 2025 C2");
    }
